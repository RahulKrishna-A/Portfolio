    ...
    return(
        <div id={"Hero_container"}>
            <motion.div className={"Hero"} variants={motionContainer} initial='hidden'
                ...
                <motion.div className={"Hero_description"} variants={child}><p style={{marginBottom: "1rem"}}>An aspiring software
                ...
                <motion.button style={{marginLeft:0,marginTop:"1.5rem",}} variants={child} className={"mail_button"}><a style={{textDecoration:"None"}} href={"mailto:rahulkrish321123@gmail.com"}>Mail me!</a></motion.button>
            </motion.div>
